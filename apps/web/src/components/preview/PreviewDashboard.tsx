...
export function PreviewDashboard({ snapshot }: { snapshot: SafePersistenceSnapshot }) {
  ...
  return (
    <div className="space-y-4 overflow-x-hidden">
      ...
      <section className="studio-card p-4 sm:p-5">
        <h2 className="font-display text-xl font-semibold text-[var(--color-text)]">TivvleJoy Scenery</h2>
        <p className="mt-1 text-sm leading-6 text-[var(--color-text-muted)]">
          Preview Only. Plan scenery from recipes. No Render.
        </p>
        <Link href="/scenery" className="btn-primary mt-4 w-full px-4 text-sm sm:w-auto">
          Open Scenery
        </Link>
      </section>
      <section className="studio-card p-4 sm:p-5">
        <h2 className="font-display text-xl font-semibold text-[var(--color-text)]">Episode Scene Planner</h2>
        <p className="mt-1 text-sm leading-6 text-[var(--color-text-muted)]">
          Planning only. No Blender render. No paid GPU. No commercial assets processed.
        </p>
        <Link href="/episode-planner" className="btn-primary mt-4 w-full px-4 text-sm sm:w-auto">
      ...
      <section className="studio-card p-4 sm:p-5">
        ...
        <p className="mt-1 text-sm leading-6 text-[var(--color-text-muted)]">
          Review Meadow Map Mystery: story, 10-shot timeline, dialogue, and current blockers. No
          render or paid compute.
        </p>
        <Link href="/episode-one" className="btn-primary mt-4 w-full px-4 text-sm sm:w-auto">
          Open Episode 1 Review
        </Link>
      </section>
      <section className="studio-card p-4 sm:p-5">
      ...
      <section className="studio-card p-4 sm:p-5">
        <h2 className="font-display text-xl font-semibold text-[var(--color-text)]">Blender Assembly Dry Run</h2>
        <p className="mt-1 text-sm leading-6 text-[var(--color-text-muted)]">
          Dry run only. Blender not executed. Commercial assets not read. Execution authorized = false.
        </p>
        <Link href="/blender-assembly" className="btn-primary mt-4 w-full px-4 text-sm sm:w-auto">
      ...
      <section className="studio-card p-4 sm:p-5">
        <h2 className="font-display text-xl font-semibold text-[var(--color-text)]">World Builder</h2>
        <p className="mt-1 text-sm leading-6 text-[var(--color-text-muted)]">
          Planning only. No Blender execution. Scenery purchase required defaults to NO.
        </p>
        <Link href="/world-builder" className="btn-primary mt-4 w-full px-4 text-sm sm:w-auto">
          Open World Builder
        </Link>
      </section>
    </div>
