...
export type GoatPaidExecutionBlocker =
  ...
  | 'LIVE_AUTHORIZATION_V4_REQUIRED';
...
export function evaluateGoatPaidExecutionAuthorization(input?: {
  ...
  if (authorizationName !== GOAT_CURRENT_LIVE_PAID_EXECUTION_AUTHORIZATION) {
    blockers.push('LIVE_AUTHORIZATION_V4_REQUIRED');
  }
  ...
  return {
    ...
    nextStep: launchAllowed
      ...
      : 'Do not launch. Use the digest-pinned V4 worker with durable output persistence and a fresh unconsumed V4 authorization.',
