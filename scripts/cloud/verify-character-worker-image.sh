...
echo "$CAPABILITY" | grep -q 'TIVVLEJOY_GOAT_REAL_PAID_EXECUTION_AUTHORIZATION_V5' || die "V5 authorization binding missing"
echo "$CAPABILITY" | grep -q 'TIVVLEJOY_CHARACTER_MASTER_DISPATCH_V5' || die "V5 entrypoint missing"
