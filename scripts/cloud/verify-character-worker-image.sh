...
echo "$CAPABILITY" | grep -q 'TIVVLEJOY_GOAT_REAL_PAID_EXECUTION_AUTHORIZATION_V6' || die "V6 authorization binding missing"
echo "$CAPABILITY" | grep -q 'TIVVLEJOY_CHARACTER_MASTER_DISPATCH_V6' || die "V6 entrypoint missing"
