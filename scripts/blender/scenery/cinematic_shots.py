...
def default_shot_cameras() -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "start": {"location": (-20.0, -20.0, 2.8), "look": (8.0, -12.0, 0.15), "lens": 35.0},
            "end": {"location": (-8.0, -18.0, 3.0), "look": (18.0, -10.0, 0.25), "lens": 38.0},
        },
        {
            "id": "SHOT_03",
            "camera": "TJ_SHOT_03_CAM",
            "start": {"location": (-38.0, 34.0, 4.6), "look": (-32.0, 20.0, 3.8), "lens": 48.0},
            "end": {"location": (-36.0, 28.0, 5.0), "look": (-28.0, 14.0, 3.6), "lens": 52.0},
        },
        {
            "id": "SHOT_04",
        ...
        },
        {
            ...
            "start": {"location": (30.0, -62.0, 22.0), "look": (2.0, 84.0, 30.0), "lens": 70.0},
            "end": {"location": (28.0, -58.0, 23.0), "look": (1.0, 90.0, 32.0), "lens": 78.0},
        },
        {
            "id": "SHOT_06",
