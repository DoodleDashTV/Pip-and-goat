    ...
    return [
        {
            ...
            "start": {"location": (14.0, -74.0, 38.0), "look": (0.0, 40.0, 16.0), "lens": 24.0},
            "end": {"location": (10.0, -62.0, 32.0), "look": (0.0, 34.0, 13.0), "lens": 26.0},
        },
        {
            "id": "SHOT_02",
            "camera": "TJ_SHOT_02_CAM",
            "start": {"location": (-22.0, -16.5, 1.9), "look": (6.0, -12.0, 0.15), "lens": 36.0},
            "end": {"location": (-12.0, -15.5, 2.1), "look": (14.0, -11.0, 0.25), "lens": 38.0},
        },
        {
            "id": "SHOT_03",
        ...
        },
        {
            ...
            "start": {"location": (1.2, -38.0, 6.6), "look": (0.0, 12.0, 3.0), "lens": 34.0},
            "end": {"location": (0.8, -28.0, 7.0), "look": (0.4, 14.0, 3.2), "lens": 38.0},
        },
        {
            "id": "SHOT_05",
        ...
        },
        {
            ...
            "start": {"location": (12.0, -36.0, 8.8), "look": (0.0, 12.0, 4.0), "lens": 42.0},
            "end": {"location": (9.0, -30.0, 8.2), "look": (0.0, 10.0, 3.6), "lens": 48.0},
        },
    ]
