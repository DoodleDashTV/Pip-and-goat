...
def default_shot_cameras() -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "start": {"location": (-18.5, -21.2, 3.15), "look": (3.0, -11.4, -0.22), "lens": 36.0},
            "end": {"location": (-8.5, -20.4, 3.18), "look": (12.0, -10.6, -0.12), "lens": 38.0},
        },
        {
            "id": "SHOT_03",
        ...
        },
        {
            ...
            "start": {"location": (7.2, -32.0, 7.6), "look": (0.0, 10.0, 3.2), "lens": 42.0},
            "end": {"location": (5.8, -26.0, 7.2), "look": (0.0, 9.0, 3.0), "lens": 48.0},
        },
    ]
