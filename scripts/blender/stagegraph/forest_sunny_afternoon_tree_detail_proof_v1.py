"""Locked-camera sunny-afternoon sky and tree-detail proof."""
...
from forest_sunny_afternoon_tree_detail_v1 import apply_sunny_afternoon_tree_detail
...
def render_still(scene, path: Path) -> dict:
    ...
    if not path.is_file():
        raise RuntimeError("SUNNY_AFTERNOON_PROOF_MISSING:" + path.name)
...
def main():
    ...
    receipt = {
        "schema": "TIVVLEJOY_FOREST_SUNNY_AFTERNOON_TREE_DETAIL_PROOF_V1",
        "result": "RENDERED",
        "paidCreateCount": 0,
        "paidSpendUsd": 0,
