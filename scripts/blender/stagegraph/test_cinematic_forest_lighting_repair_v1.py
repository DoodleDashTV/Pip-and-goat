...
class CinematicForestLightingRepairTest(unittest.TestCase):
    ...
    def test_flora_ao_crush_is_neutralized_without_emission(self):
        ...
        self.assertEqual(TRUNK_BRIGHT, 0.06)
        self.assertEqual(TRUNK_STRENGTH, 0.20)
        self.assertLess(TRUNK_MIN_LUMA, 0.12)
        ...
        self.assertEqual(_clamp_hot_flora_color((0.80, 0.12, 0.10, 1.0), "flower"), (0.80, 0.12, 0.10, 1.0))
