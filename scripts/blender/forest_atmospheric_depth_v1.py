...
VOLUME_DENSITY = 0.0038
VOLUME_COLOR = (0.90, 0.82, 0.66, 1.0)
VOLUME_ANISOTROPY = 0.68
VOLUME_Y_MAX = 40.0
VOLUME_Z_MIN = 0.32
...
Z_SKY_CUTOFF = 50.0
HAZE_STRENGTH = 0.16
HAZE_COLOR = (0.62, 0.70, 0.82, 1.0)

DEPTH_SUN_ENERGY = 42.0
DEPTH_FILL_ENERGY = 228.0
DEPTH_RIM_ENERGY = 5.4
