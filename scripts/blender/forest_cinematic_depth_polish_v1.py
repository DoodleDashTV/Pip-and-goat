...
HAZE_CARDS = (
    ("TJ_PolishHaze_FG_V1", (0.0, 3.2, 3.4), (22.0, 8.5), 0.045, (0.93, 0.86, 0.70, 1.0)),
    ("TJ_PolishHaze_MG_V1", (0.0, 13.4, 4.2), (26.0, 9.5), 0.085, (0.86, 0.82, 0.74, 1.0)),
    ("TJ_PolishHaze_BG_V1", (0.0, 23.6, 5.0), (30.0, 10.5), 0.13, (0.70, 0.78, 0.90, 1.0)),
)

COMPOSITOR_HAZE_STRENGTH = 0.13
COMPOSITOR_CONTRAST = 0.08
COMPOSITOR_SHADOW_LIFT = 0.03
